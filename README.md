...
| Environment | Clutter height | 150 MHz | 1 GHz | 10 GHz |
|---|---|---|---|---|
| Open | 0 m | 0 dB | 0 dB | 0 dB |
| Suburban | 10 m | 4 dB | 8 dB | 13 dB |
| Forested | 15 m | 7 dB | 11 dB | 16 dB |
| Urban | 25 m | 10 dB | 14 dB | 19 dB |

**Antenna height matters.** Values in the table assume both antennas at typical environment heights (in the clutter). If your antenna is well above the canopy or rooftops, clutter loss drops significantly — a 30m tower above 15m treetops gets only ~3 dB of forest loss at VHF instead of 7 dB. The model uses the lower antenna as the controlling one (a tower at one end doesn't help if the other end is in the trees).
